...
- Saves figures under `analysis/figures/YYYYMMDD-<initials>-<slug>_*.png` (at least one
  comparison figure for the primary metric, usually F1)
- Saves CSV tables/caches under `analysis/csv/YYYYMMDD-<initials>-<slug>_*.csv`
  (not `analysis/figures/`; this folder is gitignored)
- Uses `analysis/_wandb_utils.py` helpers (`default_entity`,
  `unwrap_summary_value`, `figures_dir`, `csv_dir`)
...
### Figures
![...](../../analysis/figures/YYYYMMDD-<initials>-<slug>_....png)
```
