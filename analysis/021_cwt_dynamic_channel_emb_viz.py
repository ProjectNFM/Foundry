"""Experiment 021: CWT-CNN dynamic channel embedding visualization.
...
CONDITIONS = {
    "ch-disabled": "021_disabled",
    "ch-dynamic": "021_dynamic",
}
...
def plot_backbone_comparison(backbone_cache: dict, out_dir: Path):
    ...
    fig.suptitle(
        "Exp 021: CWT-CNN Backbone Embeddings — Disabled vs Dynamic (by Sleep Stage)",
        fontsize=13,
        fontweight="bold",
    )
    fig.tight_layout(rect=[0, 0, 1, 0.96])
    fig.savefig(out_dir / "021_backbone_comparison.png", dpi=150)
    print(f"Saved: {out_dir / '021_backbone_comparison.png'}")
    plt.close(fig)
...
def plot_backbone_by_session(backbone_cache: dict, out_dir: Path):
    ...
    fig.suptitle(
        "Exp 021: CWT-CNN Backbone Embeddings — Disabled vs Dynamic (by Session)",
        fontsize=13,
        fontweight="bold",
    )
    fig.tight_layout(rect=[0, 0, 1, 0.96])
    fig.savefig(out_dir / "021_backbone_by_session.png", dpi=150)
    print(f"Saved: {out_dir / '021_backbone_by_session.png'}")
    plt.close(fig)
...
def plot_channel_emb_by_channel(
    ...
    fig.suptitle(
        "Exp 021: CWT-CNN Dynamic Channel Embeddings — by Channel Type",
        fontsize=13,
        fontweight="bold",
    )
    fig.tight_layout(rect=[0, 0, 1, 0.95])
    fig.savefig(out_dir / "021_channel_emb_by_channel.png", dpi=150)
    print(f"Saved: {out_dir / '021_channel_emb_by_channel.png'}")
    plt.close(fig)
...
def plot_channel_emb_by_session(
    ...
    fig.suptitle(
        "Exp 021: CWT-CNN Dynamic Channel Embeddings — by Session",
        fontsize=13,
        fontweight="bold",
    )
    fig.tight_layout(rect=[0, 0, 1, 0.95])
    fig.savefig(out_dir / "021_channel_emb_by_session.png", dpi=150)
    print(f"Saved: {out_dir / '021_channel_emb_by_session.png'}")
    plt.close(fig)
...
def plot_channel_emb_by_stage(
    ...
    fig.suptitle(
        "Exp 021: CWT-CNN Dynamic Channel Embeddings — by Sleep Stage",
        fontsize=13,
        fontweight="bold",
    )
    fig.tight_layout(rect=[0, 0, 1, 0.95])
    fig.savefig(out_dir / "021_channel_emb_by_stage.png", dpi=150)
    print(f"Saved: {out_dir / '021_channel_emb_by_stage.png'}")
    plt.close(fig)
...
def plot_channel_emb_combined(
    ...
    fig.suptitle(
        "Exp 021: CWT-CNN Dynamic Channel Embeddings — Combined View",
        fontsize=14,
        fontweight="bold",
    )
    fig.tight_layout(rect=[0, 0, 1, 0.96])
    fig.savefig(out_dir / "021_channel_emb_combined.png", dpi=150)
    print(f"Saved: {out_dir / '021_channel_emb_combined.png'}")
    plt.close(fig)
...
def print_summary(out_dir: Path):
    ...
    print("\n" + "=" * 65)
    print("Experiment 021: CWT-CNN Dynamic Channel Embedding Analysis Summary")
    print("=" * 65)
...
def main():
    ...
    print("Experiment 021: CWT-CNN Dynamic Channel Embedding Analysis")
