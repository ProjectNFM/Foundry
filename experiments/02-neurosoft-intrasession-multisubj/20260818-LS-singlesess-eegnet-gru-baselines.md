...
![Matched-session F1: EEGNet and GRU vs session POYO](../../analysis/figures/20260818-LS-singlesess-eegnet-gru-baselines_f1_matched_vs_poyo.png)

**Supplementary — per-session bars (excl. outliers):**
