...
- **Model:** From-scratch POYO-EEG, fixed at `embed_dim=256`, depth 4, 8 cross-/self-attention heads, static channel and session embeddings, and `channel_fusion=concat`.
...
| `model.channel_emb_mode`, session embedding | fixed static configuration |
