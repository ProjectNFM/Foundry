...
\begin{table}[H]
      ...
      \begin{tabular}{llrrr}
            ...
            CWT\_LR\_AND\_PARAM\_MATCH   & Behavior      & 3e-4        & 0.007       & 2 $\times$ 2                    \\
            \bottomrule
      \end{tabular}
...
remains an open question---this is addressed next.


% -------------------------------------------------------------------
\subsection{Parameter-Matched CWT+CNN vs.\ CNN}
...
stemming from the CWT's 18 learnable parameters and the higher
